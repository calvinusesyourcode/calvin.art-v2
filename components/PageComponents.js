...
export function ProjectOverview(props) {
    ...
    return (
        <>
        <div id={project+"_div"} className={"mrg-left div2 pad rounded bottom"+styles.bottom}>
        <div id={project+"_button"} width="440" className="clickable f f-start2 f-center gap w100" onClick={() => {
            ...
            setDropdown(!dropdown)
                ...
                <svg className="w100 center" id={project+"_svg"} height="50" xmlns="http://www.w3.org/2000/svg" viewBox="80 8 500 100">
                    <defs>
