...
export default function DennisPage(props) {
    ...
    return (
        ...
        <main className="no-mrg">
            <div className="home-page f f-col gap-tiny div2 pad rounded">
                <div className="f gap f-start2">
                        
                    <Image height={"100"} width="100" src="https://firebasestorage.googleapis.com/v0/b/calvin-art.appspot.com/o/public%2Fcto.png?alt=media&token=59aaa317-89d8-4170-8782-4e827992df18"  />
                    <div className="f f-col f-start2">
                        {create_p([`"The executive in charge of an organization's technological needs as well as its research and development (R&D)"`])}
                    </div>
                </div>
